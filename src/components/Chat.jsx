...
const Chat = () => {
  const { currentColor, pageClose } = useStateContext();

  return (
    <>
{ pageClose && (    <div className="nav-item absolute right-5 md:right-52 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
